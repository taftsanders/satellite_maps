        ...
        for file in helper.directory_content('activationkey_org'):
            ...
            for ak in self.information:
                ...
                try:
                    ...
                    print(helper.redtext + 'None, this could be a problem as your AK doesnt have a home')
                ...
                if ak.get('service_level') == None:
                    print('Service level: ', ak.get('service_level'))
                else:
                    print(helper.redtext + 'Service level: ', ak.get('service_level'))
                ...
                try:
                    ...
                    print(helper.redtext + 'None, this could be a PROBLEM as you cant save AK without a CV')
